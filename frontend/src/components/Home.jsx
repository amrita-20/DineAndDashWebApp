  ...
  return (
    <>
      ...
      <p className="home-text">
        ...
        the Caprese Delight, featuring sun-ripened tomatoes, creamy buffalo
        mozzarella, and fragrant basil, or the Mediterranean Medley, bursting
        with roasted vegetables, olives, and tangy feta cheese. Join us in our
        festive outdoor garden, adorned with twinkling lights and the lively
